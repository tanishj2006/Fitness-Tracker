...
public class Login extends javax.swing.JFrame {
    ...
    private void setupUI() {
        ...
        submitButton.addActionListener((ActionEvent e) -> {
            ...
            if (name1.equals("") || password.equals("")) {
                JOptionPane.showMessageDialog(null, "Name and password cannot be empty!");
                return;
            }
            int userId = loginUser(name1, password);
   ...
   private int loginUser(String name, String password) {
    int userId = -1;
